...
@section('page_title', 'Tambah Bidang')
@section('page_subtitle', 'Buat bidang / jabatan baru')
...
<div class="form-content">
    ...
    <div class="greeting-section" style="margin-bottom: var(--space-5);">
        <h1 class="greeting-title">Tambah Bidang</h1>
        <div class="greeting-sub">
            <span><i class="bi bi-briefcase me-1"></i> Isi data bidang / jabatan baru</span>
        </div>
    </div>

    <div class="form-card">
        <div class="card-header">
            <h5 class="card-title" style="font-weight:700; margin:0;"><i class="bi bi-plus-circle me-2"></i>Form Bidang</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('settings.positions.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: UMUM & IT, SDM & K3" required>
                </div>
