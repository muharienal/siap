...
@section('page_subtitle', 'Ubah data karyawan dan akun pengguna')
...
<div class="form-content">
    ...
    <div class="greeting-section" style="margin-bottom: var(--space-5);">
        <h1 class="greeting-title">Edit Pengguna</h1>
        <div class="greeting-sub">
            <span><i class="bi bi-person-gear me-1"></i> Ubah data karyawan dan akun pengguna</span>
        </div>
    </div>

    <div class="form-card">
        <div class="card-header">
            <h5 class="card-title" style="font-weight:700; margin:0;"><i class="bi bi-pencil-square me-2"></i>Form Pengguna</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ old('email', $user->email) }}" placeholder="email@domain.com">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">No. Telepon</label>
                            <input type="text" name="phone_number" class="form-control" value="{{ old('phone_number', $user->phone_number) }}" placeholder="08xxxxxxxxxx">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="role" class="form-select" required>
                                <option value="2" {{ old('role', $user->role) == 2 ? 'selected' : '' }}>Pengguna</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted" style="font-size:var(--font-size-xs);">Isi hanya jika ingin mengganti password</small>
                        </div>
                    </div>
                </div>
