...
@section('page_subtitle', 'Ubah data fasilitas')
...
<div class="form-content">
    ...
    <div class="greeting-section" style="margin-bottom: var(--space-5);">
        <h1 class="greeting-title">Edit Fasilitas</h1>
        <div class="greeting-sub">
            <span><i class="bi bi-tools me-1"></i> Ubah data fasilitas</span>
        </div>
    </div>

    <div class="form-card">
        <div class="card-header">
            <h5 class="title"><i class="bi bi-pencil-square"></i> Form Fasilitas</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
