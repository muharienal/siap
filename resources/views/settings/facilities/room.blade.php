...
<style>
    ...
    .add-facility-row select, .add-facility-row input[type="number"] {
        height: 44px;
        border-radius: var(--radius-sm);
    ...
    .add-facility-row select:focus, .add-facility-row input:focus {
        border-color: var(--brand-orange);
        box-shadow: 0 0 0 3px rgba(249,115,22,0.12);
    }
    .add-facility-row select { flex: 1; min-width: 220px; }
    .add-facility-row input[type="number"] { width: 90px; text-align: center; }
