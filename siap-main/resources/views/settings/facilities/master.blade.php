...
<div class="settings-content">
    ...
    <div class="greeting-section" style="margin-bottom: var(--space-5);">
        <a href="{{ route('settings.facilities.index') }}" style="font-size:var(--font-size-sm); color:var(--text-muted); text-decoration:none; display:inline-flex; align-items:center; gap:4px; margin-bottom:var(--space-2);">
            <i class="bi bi-arrow-left"></i> Kembali ke Fasilitas Ruangan
        </a>
        <h1 class="greeting-title">Data Master Fasilitas</h1>
        <div class="greeting-sub">
            <span><i class="bi bi-tools me-1"></i> Kelola jenis & stok fasilitas yang tersedia</span>
        </div>
    </div>
